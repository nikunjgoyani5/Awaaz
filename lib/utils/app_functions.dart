...
class AppFunctions {
  static Future<void> onTokenExpire(BuildContext context) async {
    String email = StorageService.getEmail() ?? '';
    String pass = StorageService.getPass() ?? '';
    bool isSaved = StorageService.getIsSaveCredentials() ?? false;
    ...
    showToast(
        ...
        title: 'Token Expired!',
        message:
            'Your token has expired. Please log in again to regain access to your account securely.'
 ...
 static   int getMobileNumberLength(String phoneCode) {
   const Map<String, int> phoneCodeLengthMap = {
     '+1': 10, // USA, Canada
   ...
   return phoneCodeLengthMap[phoneCode] ?? 10;
 }
