...
class AddNewEvents extends StatefulWidget {
  final String? page;
  final FilterEvents? selectedEvent;
  final bool? isUser;
  final String ? draftId;

  const AddNewEvents(
      {super.key, required this.page, this.selectedEvent, this.isUser, this.draftId});
...
class _AddNewEventsState extends State<AddNewEvents> {
  ...
  getAllReactionAndCategoryAPI() async {
    await controller.getAllReactions(context: context);
  ...
  Future init() async {
    await getAllReactionAndCategoryAPI();
                          ...
                          onPressed: () {
                            if (widget.draftId != null) {
                              NavigatorRoute.navigateBack(context: context);
                                ...
                                controller.eventTitleController.text.isEmpty &&
                                controller.eventDescriptionController.text.isEmpty &&
                                controller.eventLongitudeController.text.isEmpty &&
                                controller.eventAddressController.text.isEmpty &&
                                controller.eventLatitudeController.text
                                    .isEmpty
                            ) {
                              NavigatorRoute.navigateBack(context: context);
                            }
                    ...
                    SizedBox(
                      ...
                      child: Theme(
                        ...
                        child: Scrollbar(
                          ...
                          interactive: true,
                          controller: controller.createEventScrollController,
                                ...
                                children: [
                                  Row(
                                    children: [
                                      widget.draftId != null ?
                                      Expanded(
                                        child: controller.selectedEventDraftData
                                            .thumbnail != null
                                            ? Container(
                                          height: 200.h,
                                          ...
                                          :
                                      Expanded(child: widget.isUser == true
                                          ? Container(
                                        height: 200.h,
                                        alignment: Alignment.center,
                                        width:
                                      ...
                                      Expanded(child: (controller
                                        ...
                                        onHover: (_) =>
                                            setState(
                                                    () =>
                                                isHoveredCustom = true),
                                        onExit: (_) =>
                                            setState(
                                                    () =>
                                                isHoveredCustom = false),
                                        child: Stack(
                                          children: [
                                            Container(
                                              height: 200.h,
                                          ...
                                          children: [
                                            ...
                                            DropdownButtonHideUnderline(
                                              child: DropdownButton2<Categorie>(
                                                ...
                                                items: controller.eventCategory
                                                    .map(
                                                      (item) =>
                                                      DropdownMenuItem(
                                                        value: item,
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(
                          ...
                          height: 40.h,
                          child: CommonButton(
                            color: controller.selectedDateTime
                            ...
                            onPressed: () async {
                              if (widget.draftId != null) {
                                await controller.updateEventDraft(
