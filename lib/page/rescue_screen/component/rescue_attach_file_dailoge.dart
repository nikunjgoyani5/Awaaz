...
class RescueAttachFileDailoge extends StatefulWidget {
  const RescueAttachFileDailoge({super.key});

  @override
  State<RescueAttachFileDailoge> createState() =>
      _RescueAttachFileDailogeState();
}

class _RescueAttachFileDailogeState extends State<RescueAttachFileDailoge> {
              ...
              Align(
                ...
                child: SizedBox(
                  ...
                  child: CommonButton(
                    ...
                    radius: 5.r,
                    onPressed: () async {
                      await controller.uploadPostFilesAPI(pl, context);
                    },
                    widget: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
