...
class RescueLocationAndCalenderView extends StatefulWidget {
  const RescueLocationAndCalenderView({super.key});

  @override
  State<RescueLocationAndCalenderView> createState() =>
      _RescueLocationAndCalenderViewState();
}

class _RescueLocationAndCalenderViewState
    extends State<RescueLocationAndCalenderView> {
                          ...
                          children: [
                            ...
                            Checkbox(
                              ...
                              onChanged: (value) async {
                                ...
                                controller.pageNumber = 1;
                                controller.rescueSearchController.clear();
                                await controller.getRescueList(
                                    context: context);
                              },
                            ),
                            const Gap(
                            ...
                            Tooltip(
                              ...
                              message:                   "When this filter is selected, then only the entered location & specific date's Rescue data will be shown in dashboard.",
